...
- [Realm Database](https://github.com/susairajs/XamarinForms-Realm): Realm Database is a sample to show how to create a app xamarin forms with Realm Database. [ Forms: iOS, Android]
